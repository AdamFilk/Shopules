		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a href="cart.php?id=<?=$i_id?>" class="addtocartBtn text-decoration-none"
								data-id="<?=$i_id?>"
								data-name="<?=$i_name?>"
								data-codeno="<?=$i_codeno?>"
								data-photo="<?=$i_photo?>"
								data-price="<?=$i_price?>"
								data-discount="<?=$i_discount?>"
								>Add to Cart</a>
								
									
								
								<a href="item_detail.php?id=<?=$i_id?>" class="addtocartBtn text-decoration-none"
								>Item Detail</a>
